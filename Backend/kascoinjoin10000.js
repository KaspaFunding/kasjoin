...
const KASJOIN_POOL_WALLET = process.env.KASJOIN_POOL_WALLET_10000; 
const KASJOIN_POOL_PRIVATE_KEY = process.env.KASJOIN_POOL_PRIVATE_KEY_10000; 
const MIN_ENTRY_AMOUNT = 1_000_000_000_000n; // 10000 KAS in sompi
const FIXED_ENTRY_AMOUNT = 1_000_000_000_000n; // 10000 KAS in sompi
...
console.log(`[KasJoin] KASJOIN_POOL_WALLET_10000: ${KASJOIN_POOL_WALLET ? 'SET' : 'NOT_SET'}`);
console.log(`[KasJoin] KASJOIN_POOL_PRIVATE_KEY_10000: ${KASJOIN_POOL_PRIVATE_KEY ? 'SET' : 'NOT_SET'}`);
...
if (!KASJOIN_POOL_WALLET) {
  console.error('[KasJoin] KASJOIN_POOL_WALLET_10000 environment variable is not set!');
}
if (!KASJOIN_POOL_PRIVATE_KEY) {
  console.error('[KasJoin] KASJOIN_POOL_PRIVATE_KEY_10000 environment variable is not set!');
}
if (KASJOIN_POOL_PRIVATE_KEY && KASJOIN_POOL_PRIVATE_KEY.length !== 64) {
  console.error('[KasJoin] KASJOIN_POOL_PRIVATE_KEY_10000 should be 64 characters (32 bytes hex)');
}

const KASJOIN_SESSIONS_KEY = 'kasjoin_sessions_10000kas';
const KASJOIN_BATCHES_KEY = 'kasjoin_batches_10000kas';
const KASJOIN_PAUSED_KEY = 'kasjoin_paused_10000kas';
const KASJOIN_BATCH_NUMBER_KEY = 'kasjoin_batch_number_10000kas';
